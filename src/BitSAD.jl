...
include("hwhandlers/saddhandler.jl")
include("hwhandlers/ssubhandler.jl")
include("hwhandlers/smulthandler.jl")
include("hwhandlers/sdivhandler.jl")
include("hwhandlers/sfdivhandler.jl")
include("hwhandlers/ssqrthandler.jl")
include("hwhandlers/sl2normhandler.jl")
include("hwhandlers/smaxhandler.jl")
include("hwhandlers/transposehandler.jl")
include("hwhandlers/reshapehandler.jl")
include("hwhandlers/identityhandler.jl")
include("hwhandlers/sbitstreamhandler.jl")
